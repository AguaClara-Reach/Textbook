...
.. csv-table:: Chemical Dosing General Specifications
   ...
   Required chemicals, "Coagulant, Chlorine"
...
Purpose and Description
^^^^^^^^^^^^^^^^^^^^^^^
The chemical stock tanks are used to store the following chemicals: coagulant and chlorine. There are two storage tanks for each chemical.
...
.. figure:: Images/chem_platform_bottom.png
   :width: 700px
   :align: center
...
.. figure:: Images/chem_platform_cutout.png
   :width: 700px
   :align: center
   :alt: chemical stock tank bottom
...
.. csv-table:: Chemical Platform - Bottom View Cut-Out Figure Key for :numref:`figure_chem_platform_cutout`
   ...
   "6", "Pipe clamping hangers"
   "7", "Union to connect chemical piping to CLT"
   "8", "Valve for chemical drainage"

.. _figure_chem_stock_tank_section_basic:
...
.. csv-table:: Chemical Platform Section View Figure Key for :numref:`figure_chem_stock_tank_section_basic`
   :header: "Key", "Description"
   :align: left
   :widths: 20 80
   :class: wraptable
...
Plant Specifications
^^^^^^^^^^^^^^^^^^^^^
.. csv-table:: Chemical Platform Specifications for :numref:`figure_chemical_stock_tanks_overview`-:numref:`figure_chem_stock_tank_section_basic`
   ...
   "5-12", "Dose and drain plumbing nominal diameter", :sub:`($..chemPipes.dosing.ND) no-sub` inch
...
.. _figure_dosing_tube_module_basic:
...
.. csv-table:: Dosing Tubes Figure Key for :numref:`figure_dosing_tube_module_basic`
   :header: "Key", "Description"
   :align: left
   :widths: 20 80
   :class: wraptable
...
.. csv-table:: Coagulant dosing tube specifications for :numref:`figure_dosing_tube_module_basic`
   :header: "Key", "Parameter", "Value"
   :align: left
   :widths: 20 50 30
   :class: wraptable
...
.. csv-table:: Chlorine dosing tube specifications for :numref:`figure_dosing_tube_module_basic`
   :header: "Key", "Parameter", "Value"
   :align: left
   :widths: 20 50 30
   :class: wraptable
...
.. csv-table:: Chemical Dose Controller Figure Key for :numref:`figure_doser_overview`
   :header: "Key", "Description"
   :align: left
   :widths: 20 80
   :class: wraptable
...
Plant Specifications
^^^^^^^^^^^^^^^^^^^^^
.. csv-table:: Chemical Dose Controller Specifications for :numref:`figure_doser_overview`
   :header: "Key", "Parameter", "Value"
   :align: left
   :widths: 20 80 20
   :class: wraptable
...
.. _figure_injection_point_entrance_tank:
...
.. csv-table:: Coagulant Injection Point Figure Key for :numref:`figure_injection_point_entrance_tank`
   :header: "Key", "Description"
   :align: left
   :widths: 20 80
   :class: wraptable
...
.. _figure_injection_point_chlorine_basic:
...
.. csv-table:: Chlorine Injection Point at Wall Figure Key for :numref:`figure_injection_point_chlorine_basic`    
   :header: "Key", "Description"
   :align: left
   :widths: 20 80
   :class: wraptable
...
.. _figure_injection_point_chlorine_filter_basic:
...
.. csv-table:: Chlorine Injection Point at Filter Figure Key for :numref:`figure_injection_point_chlorine_filter_basic`
   :header: "Key", "Description"
   :align: left
   :widths: 20 80
   :class: wraptable
...
Plant Specifications
^^^^^^^^^^^^^^^^^^^^^
.. csv-table:: Injection Point Specifications for :numref:`figure_injection_point_entrance_tank`-:numref:`figure_injection_point_chlorine_filter_basic`
   :header: "Key", "Parameter", "Value"
   :align: left
   :widths: 20 80 20
   :class: wraptable
